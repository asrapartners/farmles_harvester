...
See [`reference/registry_integration.md`](registry_integration.md) for the full stage-by-stage read/write map, and [`reference/fast_mode.md`](fast_mode.md) for how the registry drives skip decisions.
